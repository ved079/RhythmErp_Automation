...
import { Ticket, Filter, RefreshCw, Loader2, Play, CheckCircle2, RotateCcw, MessageSquare, Send, Clock, Timer } from 'lucide-react'
import { toast } from 'sonner'
import type { BugReport } from '@/lib/bug-reports'
import { getBugReports, addReplyToReport, markReportReadByUser, updateBugReportStatus, getSLAStatus, getSLADeadline } from '@/lib/bug-reports'
