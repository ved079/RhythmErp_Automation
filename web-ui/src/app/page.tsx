          ...
          {selectedModule !== 'dashboard' && selectedModule !== 'my-tickets' && (
            <div className="flex flex-col flex-1 min-h-0 overflow-hidden">
              ...
              <div className="flex-1 overflow-hidden min-h-0">
                ...
                {activeTab === 'results' && <div data-tour="results" className="h-full"><ResultsTab tests={tests} passedCount={passedCount} failedCount={failedCount} totalCount={tests.length} runHistory={runHistory} onReportTest={handleReportTest} bugReportsList={bugReportsList} onRunDetail={(run) => { setSelectedRunForDetail(run); setRunDetailDialogOpen(true) }} onCompareRuns={() => setRunComparisonOpen(true)} testGroups={currentTestGroups} moduleHealth={moduleHealth} moduleName={modulePath.name} currentModuleId={selectedModule} autoReportedTestIds={autoReportedTestIds} /></div>}
