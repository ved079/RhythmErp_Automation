    ...
    ApiModule(
        ...
        sub_modules=[
            ...
            ApiSubModule(
                ...
                display="Goods Receipt Note",
                test_module="pages.private_b2b.modules.goods_receipt_note.test",
                tests=[
                    ApiTest(name="test_api_validations", display_name="API Validation Tests", docstring="Required fields, boundaries, security"),
                    ApiTest(name="test_api_update", display_name="API Update Tests", docstring="Update transporter, vehicle, items"),
                    ApiTest(name="test_ui_behaviour", display_name="UI Behaviour Tests", docstring="Search, view, edit via UI"),
                    ApiTest(name="api/test_schema", display_name="Schema Tests", docstring="Response structure verification"),
                    ApiTest(name="api/test_payload", display_name="Payload Tests", docstring="Payload variations"),
                    ApiTest(name="api/test_live", display_name="Live E2E Tests", docstring="Create, update, retrieve flow"),
                    ApiTest(name="api/test_calculations", display_name="Calculation Tests", docstring="Line amount, master total verification"),
                    ApiTest(name="api/test_perf", display_name="Performance Tests", docstring="Response time benchmarks"),
                ],
            ),
        ],
    ),
