...
def fill_receivable_form(driver, wait, data):
    logger.info("📝 Filling Receivable form (Fast-Track)...")
    
    if not select_report_name(driver, wait, "Receivable"):
    ...
    # Selecting the file format (Non-searchable for small dropdowns)
...
def run_rec(driver, wait, data):
    """Complete Receivable report flow."""
