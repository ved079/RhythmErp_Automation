...
def select_report_name(driver, wait, report_name="Inventory Summary"):
...
def fill_inventory_summary_form(driver, wait, data):
    logger.info("📝 Filling Inventory Summary form...")
    
    if not select_report_name(driver, wait, "Inventory Summary"):
    ...
    # Smart Field Map for Inventory Summary
    field_map = [
...
def run(driver, wait, data):
    """Complete Inventory Summary flow."""
