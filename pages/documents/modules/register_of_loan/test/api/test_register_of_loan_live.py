"""
test_register_of_loan_live.py â€” Live API integration tests for Register of Loan.
"""
...
@pytest.mark.api
class TestRegisterOfLoanLiveCRUD:
    """Live API CRUD tests for Register of Loan."""
