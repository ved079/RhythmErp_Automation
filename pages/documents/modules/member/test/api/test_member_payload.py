"""
test_member_payload.py â€” Fast API payload structure tests.
...
class TestMemberLiveCRUD:
    """Live API CRUD tests â€” requires valid ERP_TOKEN env var.
    ...
    def test_create_member_empty_payload_accepted(self, api_client):
        ...
        result = api_client.create_entry(payload)
        # The ERP accepts empty payloads â€” this documents the behavior
    ...
    def test_create_member_duplicate_pan_rejected(self, api_client):
        ...
        # Create second member with same PAN â€” should be rejected
