"""
Conftest for PO → PB direct flow tests.

Uses a dedicated login: kedar@rhythmflows.com / Kedar@999999 → tenant: Rolex Traders.
...
EMAIL     = os.environ.get("RHYTHMERP_PB_EMAIL",    "kedar@rhythmflows.com")
PASSWORD  = os.environ.get("RHYTHMERP_PB_PASSWORD", "Kedar@999999")
TENANT    = os.environ.get("RHYTHMERP_PB_TENANT",   "Rolex Traders")


def pytest_configure(config):
    config.addinivalue_line("markers", "po_pb: PO to PB direct flow tests")
...
def logged_in_page(browser_context):
    """Login as kedar@rhythmflows.com and select tenant 'Rolex Traders'."""
    ...
    # Tenant mat-select appears — click to open panel, then search and pick
