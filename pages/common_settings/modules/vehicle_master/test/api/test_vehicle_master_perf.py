"""test_vehicle_master_perf.py — Performance benchmarks for Vehicle Master."""
...
from pages.common_settings.modules.vehicle_master.data.vehicle_master_data import (
    generate_vehicle_master_api_payloads, generate_batch_payloads,
)
...
class TestVehicleMasterPerformance:
    def test_payload_speed(self):
        ...
        for _ in range(100): generate_vehicle_master_api_payloads(count=1)
