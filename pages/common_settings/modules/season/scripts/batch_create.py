...
Usage:
    python pages/common_settings/modules/season/scripts/batch_create.py --token <jwt> --tenant <id> --count <n>
    python pages/common_settings/modules/season/scripts/batch_create.py --token eyJhbGci... --tenant 711 --count 10
"""
