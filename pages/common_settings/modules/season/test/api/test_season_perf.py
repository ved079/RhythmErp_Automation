"""
test_season_perf.py — Performance benchmarks + Live CRUD tests.
...
from pages.common_settings.modules.season.data.season_data import (
    generate_season_api_payload, generate_batch_payloads,
)
...
class TestSeasonPerformance:
    """Verify Season payload generation meets speed benchmarks and live CRUD."""
    ...
    def test_batch_create_5_seasons(self, api_client):
        """Create, Read, and Update 5 Season entries via live API."""
