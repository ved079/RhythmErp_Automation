"""
test_bank_perf.py — Performance benchmarks for Bank payload generation.
...
class TestBankPerformance:
    ...
    def test_batch_create_5_banks(self, api_client):
        """Create 5 Banks via API and verify they are persisted."""
        pass
