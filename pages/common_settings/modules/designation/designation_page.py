...
class DesignationPage(BasePlaywrightPage):
    URL = "https://rhythmerp.algorhythms.in/#/dynamic-screens/Designation"
    ADD_BTN = "button:has-text('Add Designation')"
    ...
    STATUS_TOGGLE = "mat-slide-toggle"
    ...
    def verify_designation_exists(self, name):
        assert self.is_designation_in_table(name), f"Designation '{name}' not found in table"
