"""
test_designation_perf.py — Performance benchmarks + Live CRUD tests.
...
from pages.common_settings.modules.designation.data.designation_data import (
    generate_designation_api_payload, generate_batch_payloads,
)
...
class TestDesignationPerformance:
    """Verify Designation payload generation meets speed benchmarks and live CRUD."""
    ...
    def test_batch_create_5_designations(self, api_client):
        """Create, Read, and Update 5 Designation entries via live API."""
