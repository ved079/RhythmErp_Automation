"""
test_uom_perf.py — Performance benchmarks for UOM payload generation.
...
class TestUOMPerformance:
    """Verify UOM payload generation meets speed benchmarks."""
    ...
    def test_batch_create_5_uoms(self, api_client):
        """Create 5 UOMs via API and verify they are persisted."""
        pass
