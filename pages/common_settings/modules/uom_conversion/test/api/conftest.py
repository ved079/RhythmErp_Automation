"""
conftest.py — API-only fixtures for UOM Conversion fast tests.
...
def api_client():
    """Create an authenticated API client for UOM Conversion tests.
...
# Override the parent conftest's autouse browser fixture so API tests
# don't trigger Selenium browser launches.
@pytest.fixture(scope="function", autouse=True)
def reset_between_tests():
    """No-op override — API tests don't need browser refresh."""
    yield
