"""
test_services_master_perf.py — Performance benchmarks + Live CRUD tests.
...
class TestServicesMasterPerformance:
    """Verify Services Master payload generation meets speed benchmarks and live CRUD."""
    ...
    def test_batch_create_5_services(self, api_client):
        ...
        for i, p in enumerate(payloads):
            ...
            p["base_uom_conversion"] = f"{p['base_uom_conversion']}{ts}{i}"
