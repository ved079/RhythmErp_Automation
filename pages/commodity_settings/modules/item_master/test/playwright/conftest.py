...
from pages.commodity_settings.modules.item_master.im_playwright_page import IMPlaywrightPage
...
def im_page(logged_in_page):
    p = IMPlaywrightPage(logged_in_page)
    p.navigate_to_page()
    yield p
    try:
        p.close_popup()
