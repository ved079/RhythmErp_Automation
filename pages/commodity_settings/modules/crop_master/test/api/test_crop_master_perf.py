"""
test_crop_master_perf.py — Performance benchmarks + Live CRUD tests.
...
from pages.commodity_settings.modules.crop_master.data.crop_master_data import (
    generate_crop_master_payloads, generate_batch_payloads,
)
...
class TestCropMasterPerformance:
    """Verify Crop Master payload generation meets speed benchmarks and live CRUD."""
    ...
    def test_batch_create_5_crop_masters(self, api_client):
        """Create, Read, and Update 5 Crop Master entries via live API."""
