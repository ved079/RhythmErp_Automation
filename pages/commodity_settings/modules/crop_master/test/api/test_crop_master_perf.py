"""
test_crop_master_perf.py — Performance benchmarks for Crop Master payload generation.
...
class TestCropMasterPerformance:
    """Verify Crop Master payload generation meets speed benchmarks."""

    def test_payload_generation_speed(self):
        """Single payload generation should complete in under 10ms."""
        start = time.perf_counter()
        for _ in range(100):
            generate_crop_master_payloads(count=1)
    ...
    def test_batch_create_5_crop_masters(self, api_client):
        """Create 5 Crop Masters via API and verify they are persisted."""
        pass
