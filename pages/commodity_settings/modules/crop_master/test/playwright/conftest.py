...
from pages.commodity_settings.modules.crop_master.cm_playwright_page import CMPlaywrightPage
...
def cm_page(logged_in_page):
    p = CMPlaywrightPage(logged_in_page)
    p.navigate_to_page()
    yield p
    try:
        p.force_close_popup()
