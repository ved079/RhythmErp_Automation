...
from pages.commodity_settings.modules.item_category.ic_playwright_page import ICPlaywrightPage
...
def ic_page(logged_in_page):
    p = ICPlaywrightPage(logged_in_page)
    p.navigate_to_page()
    yield p
    try:
        p.force_close_popup()
