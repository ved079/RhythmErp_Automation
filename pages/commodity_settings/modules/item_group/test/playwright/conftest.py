...
from pages.commodity_settings.modules.item_group.ig_playwright_page import IGPlaywrightPage
...
def ig_page(logged_in_page):
    p = IGPlaywrightPage(logged_in_page)
    p.navigate_to_page()
    yield p
    try:
        p.force_close_popup()
