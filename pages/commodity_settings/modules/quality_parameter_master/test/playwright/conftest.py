...
from pages.commodity_settings.modules.quality_parameter_master.qpm_playwright_page import QPMPlaywrightPage
...
def qpm_page(logged_in_page):
    p = QPMPlaywrightPage(logged_in_page)
    p.navigate_to_page()
    yield p
    try:
        p.force_close_popup()
