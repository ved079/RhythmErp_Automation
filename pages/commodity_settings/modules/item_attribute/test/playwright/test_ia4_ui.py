...
_unique_data = lambda: _ud(attr_num=4)


@pytest.fixture(scope="function")
def ia_page(logged_in_page):
    p = IAPlaywrightPage(logged_in_page, attr_num=4)
    p.navigate_to_page()
    yield p
    try:
        p.close_popup()
