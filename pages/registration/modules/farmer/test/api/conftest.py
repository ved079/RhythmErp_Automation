"""
conftest.py — API-only fixtures for Farmer fast tests.
...
def api_client():
    """Create an authenticated API client for Farmer tests.
    ...
    schema retrieval, and other read operations.
    """
    ...
    # Verify auth works — list 1 Farmer entry
