...
from pages.registration.modules.miscellaneous_documents.miscellaneous_documents_page import MiscellaneousDocumentsPage
...
def md_page(logged_in_page):
    p = MiscellaneousDocumentsPage(logged_in_page)
    p.navigate_to_page()
    yield p
    try:
        p.force_close_popup()
