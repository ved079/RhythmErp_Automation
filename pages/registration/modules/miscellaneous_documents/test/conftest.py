"""
conftest.py — Miscellaneous Documents Screen (RhythmERP)
"""
...
def driver():
    log.separator()
    log.info("LAUNCHING BROWSER (RhythmERP - Miscellaneous Documents Tests)...")
    log.separator()
    drv = get_driver()
    drv.maximize_window()
    yield drv
...
def misc_page(logged_in_driver):
    from pages.registration.modules.miscellaneous_documents.miscellaneous_documents_page import (
        MiscellaneousDocumentsPage,
    )

    page = MiscellaneousDocumentsPage(logged_in_driver)
