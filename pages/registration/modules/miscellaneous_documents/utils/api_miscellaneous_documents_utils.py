"""
api_miscellaneous_documents_utils.py
-------------------------------------
Miscellaneous Documents-specific API wrapper.
"""
...
from pages.registration.modules.miscellaneous_documents.api.endpoints import SCREEN_NAME
from pages.registration.modules.miscellaneous_documents.data.miscellaneous_documents_data import (
    build_api_payload,
    generate_valid_data,
)
from pages.registration.modules.miscellaneous_documents.utils.miscellaneous_documents_cleanup import (
    CleanupTracker,
)


class MiscellaneousDocumentsAPIUtils:
    ...
    def create_entry(self, data=None):
        ...
        if result is not None:
            ...
            self.tracker.track(
                ...
                document_no=str(payload.get("document_no", "")),
    ...
    def generate_unique_payload(self):
        ...
        data["name"] = f"Auto Doc - {ts}{uuid_short[:4]}"
        data["document_no"] = int(datetime.now().strftime("%H%M%S"))
