...
test_perf.py
------------
Performance tests for Constituent Documents — optional, run manually.
"""
...
from pages.registration.modules.constituent_documents.data.constituent_documents_data import generate_batch_payloads
...
class TestConstituentDocumentsPerf:
