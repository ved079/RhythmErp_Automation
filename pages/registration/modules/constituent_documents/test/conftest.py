...
from pages.registration.modules.constituent_documents.constituent_documents_page import ConstituentDocumentsPage
...
def cd_page(logged_in_page):
    p = ConstituentDocumentsPage(logged_in_page)
    p.navigate_to_page()
    yield p
    try:
        p.force_close_popup()
