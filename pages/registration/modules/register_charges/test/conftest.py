...
from pages.registration.modules.register_charges.register_charges_page import RegisterChargesPage
...
def rc_page(logged_in_page):
    p = RegisterChargesPage(logged_in_page)
    p.navigate_to_page()
    yield p
    try:
        p.force_close_popup()
