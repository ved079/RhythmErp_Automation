...
def pytest_configure(config):
    ...
    config.addinivalue_line("markers", "sanity: Full suite â€” all 45 Role Creation tests")
    config.addinivalue_line("markers", "regression: Full suite â€” all 45 Role Creation tests")
