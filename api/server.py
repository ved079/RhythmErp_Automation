...
@app.post("/api/connector-wago-chain")
def connector_wago_chain_endpoint(request: dict):
    """CONNECTOR WAGO flow — no token required, backend auto-logins."""
    count = max(1, min(int(request.get("count", 1)), 50))
